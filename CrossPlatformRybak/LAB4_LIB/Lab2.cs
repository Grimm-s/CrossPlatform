...
public static class Lab2
{
    public static void Run(string inputPath, string outputPath)
    {
        ...
        var dirtySectors = LoadDirtySectorsFromFilePath(inputPath);
        var minCleaningDistance = CalculateMinimumCleaningDistance(dirtySectors);
        
        WriteOutput(outputPath,minCleaningDistance);
    }
    ...
    private static void WriteOutput(string outputPath, int result)
    {
